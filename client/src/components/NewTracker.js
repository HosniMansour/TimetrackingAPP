...
class NewTracker extends Component {
    ...
    FinishCountUp(e) {
        ...
        console.log(time);
        // Saving is Handlet in Submit (This method just for Debug)
    }
    ...
    render() {
        return (
            <div className="container">
                <div className={(this.props.msj===null) ? 'hidden' : ''}>
                    <div className="alert alert-success alert-dismissible fade show" role="alert">
                        <button type="button" className="close" data-dismiss="alert" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                        <strong>Done!</strong> Your task have been saved !
                    </div>
                </div>
                <div className="card">
                    <h5 className="card-header">Create a new task</h5>
                        ...
                        <form onSubmit={this.onSubmit}>
                            ...
                            <div className="row">
                                ...
                                <div className="col-6 text-center">
                                    ...
                                    <br/>
                                    <div className={this.state.startedCounting ? 'hidden' : ''}>
                                        <button onClick={(e) => this.startCountUp(e)} className="btn btn-danger"><i className="fas fa-hourglass-start"></i> start</button>
                                    </div>
...
export default connect(mapStateToProps,{CreateTasks}) (NewTracker);
